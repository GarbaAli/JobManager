        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LibelleEntreprise = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    AdresseEnt = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OffreId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IntitulePoste = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    ...
                    EntId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Offres", x => x.OffreId);
                    table.ForeignKey(
                        name: "FK_Offres_AspNetUsers_EntId",
                        column: x => x.EntId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OffreId = table.Column<int>(type: "int", nullable: false),
                    CandDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Candidature", x => new { x.CandidatId, x.OffreId });
                    table.ForeignKey(
